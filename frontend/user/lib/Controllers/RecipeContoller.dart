...
class Recipe {
  ...
  Future<Map<String, dynamic>> addRecipe(String jsonData) async {
    int? userId =
        await getData(); // Assuming this function retrieves the user ID
    try {
  ...
  Future<Map<String, dynamic>> follow(followingto) async {
    ...
    var response = await Dio().post('$baseUrl/addfollow/', data: postdata);
    var responseData = response.data;
    return responseData;
  }
  ...
  Future<Map<String, dynamic>> checkfollower(followingto) async {
    ...
    print(postdata);
    var response = await Dio().get('$baseUrl/checkfollow/', data: postdata);
    var responseData = response.data;
    return responseData;
  }
  ...
  Future<Map<String, dynamic>> deletefollower(followingto) async {
    ...
    print(postdata);
    var response = await Dio().delete('$baseUrl/deletefollow/', data: postdata);
    var responseData = response.data;
    return responseData;
  }
